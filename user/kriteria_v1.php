...
$dataKriteria = [
    "Biaya masuk", "Fasilitas", "Jarak dari pusat kota", "Jumlah pengunjung", "Kualitas jalan"
];
...
Swal.fire({
    title: 'Pesan',
    text: 'Pililah kriteria sesuai prioritas yang Anda inginkan pada tempat wisata yang dicari, seperti Biaya masuk, Fasilitas, Jarak dari pusat kota, Jumlah pengunjung, dan Kualitas jalan. Misalnya Anda ingin mencari tempat wisata dengan meprioritaskan Biaya masuk pada prioritas 1, Fasilitas pada prioritas 2, Jarak dari pusat kota pada prioritas 3, Jumlah pengunjung pada prioritas 4 dan Kualitas jalan pada prioritas 5. Dari pilihan prioritas tersebut, sistem akan merekomendasikan tempat wisata dengan Biaya masuk paling murah kemudian diikuti dengan kriteria lainnya.',
    icon: 'warning',
            ...
            <div class="card">
                ...
                <form method="post" action="">
                    <div class="card-body">
                        ...
                        <button type="submit" name="edit" class="btn col-12 btn-outline-success">
                            Simpan
                        </button>
                    </div>
                </form>
